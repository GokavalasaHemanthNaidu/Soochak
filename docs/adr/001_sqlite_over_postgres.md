...
## Context
Need a database for <10K predictions/day, single writer, demo portfolio project.
...
- Migration threshold: >50 concurrent writers or persistent data requirement → PostgreSQL
